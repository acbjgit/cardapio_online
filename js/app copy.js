        ...
        if(qntdAtual > 0) {
            ...
            if(item.length > 0) {
                ...
                // Caso não exista o item no carrinho, adiciona ele ao carrinho
                    ...
                    item[0].observacao = obsAtual // talvez excluir essa linha
                ...
                // o campo de texto do Campo Observação é limpado depois que o item é adicionado ao carrinho
                $(".campoObs-" + id).val("");
                // desmarca o campo input checkbox-obs assim que o item é adicionado ao carrinho
                if($('.checkbox-obs-' + id).is(":checked")) {
                    $(".checkbox-obs-" + id).prop("checked", false);
                    // o campo de texto é removido
